...
<header class="w-full bg-amber-200 shadow rounded-b-lg px-[20px] py-[20px] sm:px-8 sm:py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
  ...
  <!-- Navigation -->
  <nav id="main-nav" class="w-full sm:w-auto mt-4 sm:mt-0 flex-col sm:flex-row flex gap-2 sm:gap-6 items-center justify-center sm:justify-end transition-all duration-300 hidden sm:flex">
    <a href="<?php echo home_url(); ?>" class="nav-link">Home</a>
    <a href="<?php echo get_post_type_archive_link('movie'); ?>" class="nav-link">Movies</a>
    <a href="<?php echo get_post_type_archive_link('actor'); ?>" class="nav-link">Actors</a>
  </nav>
</header>
